var voyage = {
  seville: {
    title: 'Seville',
    description: 'Seville is the capital and largest city of the autonomous community of Andalusia and the province of Seville, Spain. It is situated on the plain of the River Guadalquivir. The inhabitants of the city are known as sevillanos (feminine form: sevillanas) or hispalenses, after the Roman name of the city, Hispalis. Seville has a municipal population of about 703,000 as of 2011, and a metropolitan population of about 1.5 million, making it the fourth-largest city in Spain and the 30th most populous municipality in the European Union. Its Old Town, the third largest in Europe with an area of 4 square kilometres (2 sq mi), contains three UNESCO World Heritage Sites: the Alcázar palace complex, the Cathedral and the General Archive of the Indies. The Seville harbour, located about 80 kilometres (50 miles) from the Atlantic Ocean, is the only river port in Spain.',
    next: 'canaryIslands'
  },
  canaryIslands: {
    title: 'Canary Islands',
    description: 'Canary Islands, also known as the Canaries (Spanish: Canarias), are a Spanish archipelago located just off the northwest coast of mainland Africa, 100 kilometres (62 miles) west of the southern border of Morocco. The Canaries are one of Spain\'s 17 autonomous communities and are among the outermost region of the European Union proper. The islands include (from largest to smallest): Tenerife, Fuerteventura, Gran Canaria, Lanzarote, La Palma, La Gomera, El Hierro, La Graciosa, Alegranza, Isla de Lobos, Montaña Clara and Roque del Oeste.',
    next: 'capeVerde'
  },
  capeVerde: {
    title: 'Cape Verde',
    description: 'Cape Verde, officially the Republic of Cabo Verde, is an island country spanning an archipelago of 10 volcanic islands in the central Atlantic Ocean. Located 570 kilometres (350 miles) off the coast of Western Africa, the islands cover a combined area of slightly over 4,000 square kilometres (1,500 sq mi).',
    next: 'straitOfMagellan'
  },
  straitOfMagellan: {
    title: 'Strait of Magellan',
    description: 'The Strait of Magellan (also called the Straits of Magellan) is a navigable sea route immediately south of mainland South America and north of Tierra del Fuego. The strait is the most important natural passage between the Atlantic and Pacific oceans but it is considered a difficult route to navigate because of the unpredictable winds and currents and the narrowness of the passage.',
    next: 'guam'
  },
  guam: {
    title: 'Guam',
